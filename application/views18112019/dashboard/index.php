<div class="right_col" role="main">
	<div class="row top_tiles">
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			<?php
				if(!empty($this->session->flashdata('loginSuccess'))){ 
			?>
	...
	<div class="row top_tiles"> 
	  <div class="animated flipInY col-lg-2 col-md-2 col-sm-6 col-xs-12 dashboard_icon">
		<div class="tile-stats">
		  <div class="icon"><i class="fa fa-user"></i></div>
		   ...
		   <?php } ?>
		  <h3><a href="<?php echo base_url().'users'; ?>">Users</a></h3>
		</div>
	  </div>
	  ...
	  <div class="animated flipInY col-lg-2 col-md-2 col-sm-6 col-xs-12 dashboard_icon">
		<div class="tile-stats">
			...
			<?php } ?>
			<h3><a href="<?php echo base_url().'shops'; ?>">Shops</a></h3>
		</div>
	  </div>
	  <div class="animated flipInY col-lg-2 col-md-2 col-sm-6 col-xs-12 dashboard_icon">
		<div class="tile-stats">
			...
			<?php } ?>
			<h3><a href="<?php echo base_url().'sections'; ?>">Sections</a></h3>
		</div>
	  </div>
	  <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12 dashboard_icon">
		<div class="tile-stats">
