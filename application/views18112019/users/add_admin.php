					...
					<div class="col-md-6 col-xs-12 bottom-buffer">
						...
						<div class="col-md-9 col-sm-9 col-xs-12">
							<?php 
								...
								//echo "<pre>";print_r($zoneData);echo "</pre>";die(" on file ". __FILE__ ." on line ". __LINE__ );
								/* if(!empty($loggedInDetail->login_id)){
									$login_id = $loggedInDetail->login_id;
									if($login_id == 'Super Admin'){
										if(!empty($zoneCode)){ 
											echo form_dropdown('user_zone', $allZone, set_value('user_zone',$zoneCode), 'class="form-control col-md-7 col-xs-12" id="user_zone" disabled="disabled"');
										}else{
											echo form_dropdown('user_zone', $allZone, set_value('user_zone',$zoneCode), 'class="form-control col-md-7 col-xs-12" id="user_zone"');
										}
									}else{
										echo form_dropdown('user_zone', $allZone, set_value('user_zone','1'), 'class="form-control col-md-7 col-xs-12" id="user_zone" disabled="disabled"');
									}
								}*/
								echo form_dropdown('user_zone', $allZone, set_value('user_zone',$zoneCode), 'class="form-control col-md-7 col-xs-12" id="user_zone"');
									...
									/* if(!empty($loggedInDetail->login_id)){
										...
										if($login_id == 'Super Admin'){
											if(!empty($divisionCode)){
												echo form_dropdown('user_division', $allDivision, set_value('user_division',$divisionCode), 'class="form-control col-md-7 col-xs-12" id="user_division" disabled="disabled"');
											}else{
											...
											echo form_dropdown('user_division', $allDivision, set_value('user_division','1'), 'class="form-control col-md-7 col-xs-12" id="user_division" disabled="disabled"');
										}
									} */
									echo form_dropdown('user_division', $allDivision, set_value('user_division'), 'class="form-control col-md-7 col-xs-12" id="user_division"');
