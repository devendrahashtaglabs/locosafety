  ...
  <div class="">
    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
      	<div class="x_panel">
          <div class="x_title">
          	<h2><?php echo "Add New Office / Division"; ?></h2>
            <div class="clearfix"></div>
          </div>
          <div class="x_content">
            <br />
          ...
          <div class="x_content">
            <table id="divisiondatatable" class="table table-striped table-bordered">
                ...
                <tr>
                    ...
                    <td><?php //echo isset($adminEmails)?$adminEmails:''; ?></td>
                    <td>
						<?php 
							switch ($status) {
							  case '10':
					...
					<td class="division-action">
						<?php if($status == '10'){ ?>
							<a href="<?php echo base_url('divisions/editDivision/'.$singleDivisionData->division_id); ?>" class="edit"> Edit </a> <br/>
							<a href="<?php echo base_url('divisions/deleteDivision/'.$singleDivisionData->division_id); ?>" onClick="return doconfirm();" class="inactive"> Inactive </a><br/>
						<?php }else{ ?>
