      ...
      <div class="row">
        ...
        <div class="x_panel">
              ...
              <tbody>
                <?php 
                  ...
                  foreach($sectionData as $singleSectionData){
                    ...
                    //echo "<pre>";print_r($shopDetails);echo "</pre>";die(" on file ". __FILE__ ." on line ". __LINE__ );
          ...
          <td class="action">
            ...
            <a href="<?php echo base_url('sections/deleteSection/'.$singleSectionData->section_id); ?>" onClick="return doconfirm();"class="inactive"> Inactivate </a>
          </td>
                  </tr>
                <?php $counter++; } ?>
              </tbody>
