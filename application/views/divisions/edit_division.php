      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
          ...
          <div class="x_title">
            ...
            <ul class="nav navbar-right panel_toolbox">
				<li><a class="add-new btn btn-primary" href="<?php echo base_url().'divisions';?>" title="Add New">Add New</a> </li>
            </ul>
            <div class="clearfix"></div>
          </div>
          <div class="x_content">
        ...
        <div class="x_panel">
          <div class="x_title">
            <h2><?php echo 'Offices/Divisions'; ?></h2>
            <div class="clearfix"></div>
          </div>
          <div class="x_content">
            <?php 
              ...
              <tbody>
                ...
                ?>
                  <tr>
                    ...
                    <td><?php echo isset($zoneName)?$zoneCode:''; ?></td>
                    ...
                    <td class="division-action">
						<?php if($status == '10'){ ?>
							<a href="<?php echo base_url('divisions/editDivision/'.$singleDivisionData->division_id); ?>" class="edit" title="Edit"> Edit </a> 
							<a href="<?php echo base_url('divisions/deleteDivision/'.$singleDivisionData->division_id); ?>" onClick="return doconfirm();" class="inactive" title="Inactive"> Inactive </a>
