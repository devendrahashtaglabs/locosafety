						...
						<div class="form-group">
							...
							<div class="col-md-9 col-sm-9 col-xs-12">
								<?php 							
									...
									echo form_dropdown('user_division', $allDivision, set_value('user_division',$editUserData->user_division), 'class="form-control col-md-7 col-xs-12" id="user_division" disabled="disabled"');
					...
					<div class="col-md-6 col-xs-12 bottom-buffer">
						...
						<div class="col-md-9 col-sm-9 col-xs-12">
							<?php 
								...
								//echo "<pre>";print_r($loginType);echo "</pre>";die(" on file ". __FILE__ ." on line ". __LINE__ );
				...
				<div class="row">
					<div class="form-group text-center my-5">
						<div class="col-md-12 col-sm-12 col-xs-12">
							...
							?>
                                                        <input type="button" class="btn btn-danger" value="Reset" title="Reset" onclick="location.href='<?php echo base_url();?>users/editUser/<?php echo $editedId; ?>'">
							<input type="button" class="btn btn-primary" value="Cancel" title="Cancel" onclick="location.href='<?php echo base_url();?>users'">
						</div>
					</div>
				</div>
            </form>
