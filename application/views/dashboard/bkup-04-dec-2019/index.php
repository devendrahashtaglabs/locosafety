<div class="right_col" role="main">
	...
	<div class="row">
		...
		<div class="col-md-3" style="padding: 20px;">
			<div class="row BoxDiv">
				<label> Crane Attached SnH <span><?php echo isset($allHardwares)?$allHardwares:''; ?></span> </label>
				<div class="col-md-12">
					<div class="widget_summary">
				...
				<?php 
					...
					if(count($GetAllSectionData) > 0){
						...
						if($SectionData){
							...
							$craneprogress = ' <div class="progress" style="width:150px; float:left; margin-left:20px;"> <div class="progress-bar bg-green" role="progressbar" aria-valuenow="'.$cranePercentage.'"  aria-valuemin="0" aria-valuemax="100" style="width:'.$totalNoNTicket.'%"></div></div>';
							/* crane */
							/* sling */
								$cat_ids 			= array(2);
								$section_id 		= $SectionData->section_id;
								...
								$slingprogress = ' <div class="progress" style="width:150px; float:left; margin-left:20px;"> <div class="progress-bar bg-green" role="progressbar" aria-valuenow="'.$cranePercentage.'"  aria-valuemin="0" aria-valuemax="100" style="width:'.$totalNoNTicket.'%"></div></div>';
							/* sling */
							/* T&G */
								$cat_ids 			= array(3);
								$section_id 		= $SectionData->section_id;
								...
								$tgprogress = ' <div class="progress" style="width:150px; float:left; margin-left:20px;"> <div class="progress-bar bg-green" role="progressbar" aria-valuenow="'.$cranePercentage.'"  aria-valuemin="0" aria-valuemax="100" style="width:'.$totalNoNTicket.'%"></div></div>';
							/* T&G */
							/* CAS */
								$cat_ids 			= array(4);
								$section_id 		= $SectionData->section_id;
								...
								$casprogress = ' <div class="progress" style="width:150px; float:left; margin-left:20px;"> <div class="progress-bar bg-green" role="progressbar" aria-valuenow="'.$cranePercentage.'"  aria-valuemin="0" aria-valuemax="100" style="width:'.$totalNoNTicket.'%"></div></div>';
							/* CAS */
				...
				?>		
					<div class="col-loco-1 tooltip"  style="<?php echo $colorShop; ?>" > 
						...
						?>
								...
								<div class="col-xs-12 black_color"><?php echo isset($SectionData->section_name)?$SectionData->section_name:'';?></div>
								<?php //echo $j; ?>
...
<style type="text/css">	
	...
	.workshop-layout {
	background: #fff url(<?php echo base_url(); ?>assets/dashboard/images/layout.png) no-repeat;
