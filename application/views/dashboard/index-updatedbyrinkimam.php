<div class="right_col" role="main">
	...
	<div class="row">
		<?php
			...
			$allTicketHardwares	= count($this->Dashboard_model->getalltickethardwarebycategory($cat_ids));			//print_r($this->db->last_query());			//exit;
		...
		<div class="col-md-3" style="padding: 20px;">
			<div class="row BoxDiv" >
				...
				<div class="col-md-12">
					...
					<div class="row" >
						<div class="col-md-6 ">
						<div class="col-md-3 Crane-color blinkboxX">
						...
						<div class="col-md-6 ">
						<div class="col-md-3  Crane-color blinkboxi ">
	...
	<div class="row">
		<div class="col-md-12 " >
			...
			<button class="btn btn-danger" onclick="ChangeStatus(this.value);" value="B90" >Breakdown </button>			<button class="btn btn-info" onclick="ChangeStatus(this.value);" value="B60" >Due To Schedule </button>
		</div>
