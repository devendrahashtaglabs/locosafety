      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
          ...
          <div class="x_title">
			...
			<ul class="nav navbar-right panel_toolbox">
				<li><a class="add-new btn btn-primary" href="<?php echo base_url().'categories';?>" title="Add New">Add New</a>
				</li>
			</ul>
            <div class="clearfix"></div>
          </div>
						...
						<div class="col-md-12 col-sm-12 col-xs-12">
							...
							?>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <div class="col-md-12 col-sm-12 col-xs-12">                                            
                                            <input type="number" name="priority" class="form-control" id="priority" placeholder="Priority *"  value="<?php if(!empty($catDataById->category_name)){ echo $catDataById->priority; } ?>" />  
                                        </div>
                                    </div>
                                </div>
				<div class="col-md-12 col-xs-12 bottom-buffer">
